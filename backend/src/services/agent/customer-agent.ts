...
// always show availability with its freshness caveat, never invent a
// part, and the grounding rule (cite raw_name / matched attributes,
// say "I'm not sure" rather than guess) applies here same as staff.
...
- When you state a part's availability, always include its freshness (e.g. "verified 3 days ago" or "never verified by staff — treat as unconfirmed"). Never state availability without that caveat.
...
- Keep replies concise — this is a chat widget, not an email.
